...
class GithubButton extends StatefulWidget {
  // Make the text and URL configurable for reusability
  final String text;
  final String url;
      ...
      child: InkWell(
        ...
        child: Transform(
          ...
          child: AnimatedContainer(
            ...
            padding: const EdgeInsets.only(left: 28, right: 28, top: 6, bottom: 6),
            ...
            transform: _isHovered
                ? (Matrix4.identity()
                  ..translate(0, 0, -20.0) // Pop out by 20
