...
class CorporateFilterScreen extends StatefulWidget {
  const CorporateFilterScreen({super.key});

  @override
  State<CorporateFilterScreen> createState() => _CorporateFilterScreenState();
}

class _CorporateFilterScreenState extends State<CorporateFilterScreen> {
  final String _projectUrl = Links.corporateAiLink;
